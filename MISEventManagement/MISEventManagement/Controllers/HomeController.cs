...
using MISEventManagement.Modules.IPConfig;
using System.Linq;
    ...
    public class HomeController : BasicController {
        ...
        public ActionResult ContactUs(Feedback feedback) {
            ...
            if (ModelState.IsValid) {
                ...
                //send a email.
                AppVar.Mailer.NotifyAdmin("A feedback has been added by " + feedback.Email, "Please check your feedback inbox. Feedback :<br>" + feedback.Message);
