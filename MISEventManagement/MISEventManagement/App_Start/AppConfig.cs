...
using MISEventManagement.Modules.Cookie;
...
namespace MISEventManagement {
    ...
    public struct AppVar {
        ...
        public const string DefaultConnection = @"Data Source=(LocalDb)\v11.0;AttachDbFilename=|DataDirectory|\asp.net-Maganize.mdf;Initial Catalog=asp.net-Maganize;Integrated Security=True";
