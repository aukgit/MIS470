...
namespace MISEventManagement.Modules.Uploads {
    ...
    public class FileLocation {
        ...
        /// <returns></returns>
        public static string GetLocation(string fileName, string fileExtension, bool isPrivate = false, string rootPath = "~/Uploads/Files/") {
            string path = rootPath.Replace("~", appPath);
            if (isPrivate) {
                path += "Private/";
            }
        ...
        /// <returns></returns>
        public static string GetImageLocation(string fileName, string fileExtension = "jpg", PictureType pictureType = PictureType.Default, int number = -1, bool isNumbering = false, bool isPrivate = false, string rootPath = "~/Uploads/Images/") {
            string path = rootPath.Replace("~", appPath);
            string typeStr = "";
